...
txtPos = [0 1-h 1 h];
h10handles.headTxt = uicontrol(h10, ...
    'Style','text', ...
    'Units','normalized', ...
    'Position',txtPos, ...
    'String',labelStr, ...
...
for iColor = 1:rowCount
    ...
    h10handles.colorbox{iColor} = uicontrol(h10,...
        'Style','text',...
        'Units','normalized',...
        'Position',patchPos,...
    ...
    h10handles.colorLabel{iColor} = uicontrol(h10,...
        'Style','text',...
        'Units','normalized',...
        'Position',labelPos,...
    ...
    if ~isempty(p.mySpID)
        ...
        if iColor<= length(p.mySpID)
            ...
            h10handles.spLabel{iColor} = uicontrol(h10,...
                'Style','text',...
                'Units','normalized',...
                'Position',spPos,...
