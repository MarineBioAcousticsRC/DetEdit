...
filePrefix = 'GOM_MC_14'; % TPWS file name to match.
...
tpwsDir = 'E:\Code\EchoClickPipeline\Representative_files\11_GOM_Ground_Truth_Bouts\MC_Groundtruth_bouts'; % identify folder containing TPWS files
%'L:\Groundtruth_bouts\paper';
...
ltsaDir = 'K:\GOM_DT_13_Detector\GOM_DT_13_LTSA' ; % identify folder containing 
% ltsa files (.ltsa). REQUIRED to run mkLTSAsessions.m
paramsUser.labelDir = 'E:\Code\EchoClickPipeline\artifacts\review-exports\unreviewed-uncertain-v1';
paramsUser.labelItr = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
paramsUser.ltsaContrast = 160; % ltsa contrast
...
paramsUser.rmsLow = 80;
paramsUser.rmsHi = 170;
paramsUser.rlHi = 170;
paramsUser.rlLow = 120;
