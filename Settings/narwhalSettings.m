...
filePrefix = '2015_LowIsland'; % File name to match. 
...
sp = 'Mm'; % species code (can be: 'Ko' or 'k' (kogia);
% 'Zc' or 'z' (Cuvier's),'Me' or 'm' (Gervais'), 'Md' (Blainville's), BWG,...
% 'De' (Dolphin), 'Po' (porpoise), 'MFA', 'whs' (whistles), 'Dl' (beluga)
sdir = 'H:\detEdit\detEdit_ONC_NU\Det_files\ONC15LOWISLAND_narwhal\TEST01'; %Directory with TPWS files
tfName = 'H:\detEdit\detEdit_ONC_NU\Hydrophone_TFs\681_120917'; %'E:\TF_files'; % Directory ...
...
paramsUser.threshHiFreq = 90; % default for ^ command, high freq cutoff for clicks
