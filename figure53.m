...
if dPARAMS.ff3 % ID'd in associated color
    for iC2 = 1:length(dPARAMS.specIDs) % set colors
        ...
        dHANDLES.RMSID53{iColor} = plot(dHANDLES.h53,dPARAMS.transfRMS(dPARAMS.K3(thisIDset(dPARAMS.labelConfIdx))),...
            dPARAMS.freq(dPARAMS.K3(thisIDset(dPARAMS.labelConfIdx))),'.',...
